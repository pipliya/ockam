...
pub const X25519_PUBLIC_KEY_LENGTH_U32: u32 = 32; // FIXME
/// X25519 public key length.
pub const X25519_PUBLIC_KEY_LENGTH_USIZE: usize = 32;

/// Ed25519 public key length.
pub const EDDSA_CURVE25519_PUBLIC_KEY_LENGTH_U32: u32 = 32; // FIXME
/// Ed25519 public key length.
pub const EDDSA_CURVE25519_PUBLIC_KEY_LENGTH_USIZE: usize = 32;

/// NIST P256 public key length.
pub const ECDSA_SHA256_CURVEP256_PUBLIC_KEY_LENGTH_U32: u32 = 65; // FIXME
/// NIST P256 public key length.
pub const ECDSA_SHA256_CURVEP256_PUBLIC_KEY_LENGTH_USIZE: usize = 65;
...
pub struct EdDSACurve25519PublicKey(
    #[cbor(n(0), with = "minicbor::bytes")] pub [u8; EDDSA_CURVE25519_PUBLIC_KEY_LENGTH_USIZE],
);
...
pub struct ECDSASHA256CurveP256PublicKey(
    #[cbor(n(0), with = "minicbor::bytes")] pub [u8; ECDSA_SHA256_CURVEP256_PUBLIC_KEY_LENGTH_USIZE],
);
...
pub struct X25519PublicKey(
    #[cbor(n(0), with = "minicbor::bytes")] pub [u8; X25519_PUBLIC_KEY_LENGTH_USIZE],
);
